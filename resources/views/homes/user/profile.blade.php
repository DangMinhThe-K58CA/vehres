        ...
        <section class="panel">
            <header class="panel-heading tab-bg-info">
                <ul class="nav nav-tabs">
                    ...
                    <li class="{{ count($errors->all()) > 0 && session('tabStatus') === 1 ? 'active' : ''}}">
                        <a data-toggle="tab" href="#edit-profile">
                            <i class="icon-envelope"></i>
                            {{ trans('layout.update_profile') }}
                        </a>
                    </li>
                    <li class="{{ count($errors->all()) > 0 && session('tabStatus') === 2 ? 'active' : ''}}">
            ...
            <div class="panel-body">
                <div class="tab-content">
                    ...
                    <!-- edit-profile -->
                    <div id="edit-profile" class="tab-pane col-md-11 col-md-offset-1 {{ count($errors->all()) > 0 && session('tabStatus') === 1 ? 'active' : ''}}">
                        <div class="panel">
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                    ...
                    <!-- Change password -->
                    <div id="change-password" class="tab-pane col-md-8 col-md-offset-2 col-md-offset-right-2 {{ count($errors->all()) > 0 && session('tabStatus') === 2 ? 'active' : ''}}">
                        <div class="panel">
                            <div class="row">
                                <div class="panel panel-default">
                                    <div class="panel-heading"></div>
                                    <div class="panel-body">
                                        <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ action('Home\UserController@update', ['user' => 'update']) }}">
                                            ...
                                            <div class="form-group{{ $errors->has('newPassword') ? ' has-error' : '' }}">
                                                <label for="currentPassword" class="col-md-4 control-label">New password</label>
                                            ...
                                            <div class="form-group{{ $errors->has('confirmPassword') ? ' has-error' : '' }}">
                                                <label for="currentPassword" class="col-md-4 control-label">Confirm password</label>
